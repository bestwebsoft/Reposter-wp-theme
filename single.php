							...
							<article id='post-<?php the_ID(); ?>' <?php post_class(); ?>>
								<div class='reposter_cont'>
									...
									if ( wp_attachment_is_image() )
										echo "<div class='previous-image'>", previous_image_link( false, __( '&larr; Previous', 'reposter' ) ), "</div>" . "<div class='next-image'>", next_image_link( false, __( 'Next &rarr;', 'reposter' ) ), "</div>";?>
									<!--post content-->
									<?php the_content();
									wp_link_pages(); ?>
